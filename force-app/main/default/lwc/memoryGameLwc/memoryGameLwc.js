...
export default class MemoryGameLwc extends LightningElement {
      ...
      cards=[
        ...
        {id:3, listClass:"card", type:'podcast', icon:'fa fa-podcast'},
        {id:4, listClass:"card", type:'wpexplorer', icon:'fa fa-wpexplorer'},
        {id:5, listClass:"card", type:'cube', icon:'fa fa-cube'},
        {id:6, listClass:"card", type:'podcast', icon:'fa fa-podcast'},
        ...
        {id:13, listClass:"card", type:'wpexplorer', icon:'fa fa-wpexplorer'},
            ...
            displayCard(event){
                  ...
                  if(len === 2){
                        ...
                        if(this.openedCards[0].type === this.openedCards[1].type){
                              ...
                              console.log("matchedCard" + this.matchedCard.length)
                              this.matched()
                          } else {
                              this.unmatched()
                        }
